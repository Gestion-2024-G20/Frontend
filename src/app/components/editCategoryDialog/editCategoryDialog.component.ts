...
@Component({
  selector: 'editCategoryDialog.component',
  ...
  constructor(
    ...
    async onClick(): Promise<void> {
      try { 
        ...
        newCategory.id_category = this.data.id_category;
        newCategory.name = newCategoryName;
        newCategory.description = newCategoryDescription;
        newCategory.id_group = this.data.groupId;
        let updatedCategory = await lastValueFrom(this.categoryService.putCategory(newCategory)) as Category;

        // Borro los category shares viejos
        await lastValueFrom(this.categoryShareService.deleteCategoryCategoryShares(updatedCategory.id_category))

        console.log(newCategoryShares); 
        // Creo los CategoryShares
        for (const cs of newCategoryShares){
          cs.id_category = updatedCategory.id_category; 
        ...
        this.data.showError = true;
        this.data.msgError = "Error editing category: " + e;
        return; 
      } 
